  ...
  return (
    <footer className="carbon-global-footer">
      ...
      <div className="carbon-footer-shell">
        ...
        <div className="carbon-footer-trust">
          {trustItems.map((item, index) => {
            const Icon = item.icon;

            return (
              <motion.div
                className="carbon-footer-trust-item"
                key={item.title}
              ...
              >
                <span className="carbon-footer-trust-icon">
        ...
        <div className="carbon-footer-marquee" aria-hidden="true">
          <motion.div
            initial={{ x: 0 }}
            animate={{ x: "-50%" }}
            transition={{
