        ...
        <div className="home-experience-inner">
          <div className="home-footer-main">
            <div className="home-footer-brand">
              <span>CARBON</span>
              <p>
                Avtomobil icarəsi, xüsusi gün avtomobilləri və transfer
                xidmətləri.
              </p>
            </div>
            ...
            <div className="home-footer-links">
              <div>
                <span>NAVİQASİYA</span>
                <Link href="/">Ana səhifə</Link>
                <Link href="/avtomobiller">Avtomobillər</Link>
                <Link href="/toy-avtomobilleri">Toy avtomobilləri</Link>
              </div>

              <div>
                <span>ƏLAQƏ</span>
                <a href="tel:+994502200050">+994 50 220 00 50</a>
                <a href="mailto:info@carbon.az">info@carbon.az</a>
              </div>
            </div>
          </div>

          <div className="home-footer-bottom">
            <span>© {new Date().getFullYear()} CARBON RENT A CAR</span>
