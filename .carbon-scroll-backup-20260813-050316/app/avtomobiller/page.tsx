    ...
    <main className="catalog-page catalog-v2">
      ...
      >
        ...
        <div className="catalog-nav-actions">
          ...
          <Link href="/#elaqe" className="catalog-contact">
            Əlaqə saxla
            <ArrowRight size={14} />
          </Link>
